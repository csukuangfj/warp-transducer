...
# warp-rnnt uses the same abi flag as PyTorch
...
execute_process(
  ...
  OUTPUT_STRIP_TRAILING_WHITESPACE
  OUTPUT_VARIABLE RNNT_TORCH_VERSION_MAJOR
)

execute_process(
  COMMAND "${PYTHON_EXECUTABLE}" -c "import torch; print(torch.__version__.split('.')[1])"
  OUTPUT_STRIP_TRAILING_WHITESPACE
  OUTPUT_VARIABLE RNNT_TORCH_VERSION_MINOR
)
...
if(RNNT_WITH_CUDA)
  ...
  if(NOT CUDA_VERSION VERSION_EQUAL TORCH_CUDA_VERSION)
    message(FATAL_ERROR
      ...
      "But you are using CUDA ${CUDA_VERSION} to compile warp-rnnt.\n"
      "Please try to use the same CUDA version for PyTorch and warp-rnnt.\n"
